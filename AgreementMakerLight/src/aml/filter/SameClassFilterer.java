...
public class SameClassFilterer implements Filterer
{

//Constructors
	
	public SameClassFilterer(){}
...
//Public Methods
	...
	public void filter()
	{
		System.out.println("Running Same Class Filter");
		...
		for(Mapping m : a)
		{
			...
			{
				Set<Integer> sourceClasses = rels.getIndividualClasses(source);
				Set<Integer> targetClasses = rels.getIndividualClasses(target);
				boolean check = false;
				if(!sourceClasses.isEmpty() && !targetClasses.isEmpty())
				{
					for(int i : sourceClasses)
					{
